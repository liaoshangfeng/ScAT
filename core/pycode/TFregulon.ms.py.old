...
def Net_Infer():
   ...
   if args.species=='mouse':
      order='pyscenic grn --num_workers '+ args.cpu + ' --output '+ os.path.join(args.outdir,'02.Network.Adj.tsv') + ' --method grnboost2 '+ os.path.join(args.outdir,'01.Adata.Expression.loom') +' '+ os.path.join(args.tfdataset,'allTFs_mm.txt') 
        ...
        --annotations_fname  '+ os.path.join(args.tfdataset,'motifs-v9-nr.hgnc-m0.001-o0.0.tbl') +' \
         --expression_mtx_fname '+os.path.join(args.outdir,'01.Adata.Expression.loom') +' \
           ...
           --num_workers '+args.cpu+'  \
            --mask_dropouts'
    if args.species=='mouse':
        order='pyscenic ctx '+os.path.join(args.outdir,'02.Network.Adj.tsv')+' '+os.path.join(args.tfdataset,'mm9-tss-centered-10kb-10species.mc9nr.feather ') +' \
