...
parser$add_argument('--sc_rds', dest = 'sc_rds', default=NULL, help = 'Input normalized data (*.txt.gz)')
parser$add_argument('--st_rds', dest = 'st_rds', default=NULL, help = 'Input spatial transcriptome data')
...
Scdata<- readRDS(opts$sc_rds)
Stdata<-readRDS(opts$st_rds)
...
run_deconvolution <- function(Scdata, Stdata){
